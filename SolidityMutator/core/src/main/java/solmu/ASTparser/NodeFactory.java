...
public class NodeFactory {
    ...
    public NodeFactory(JSONObject node, ArrayList<Node> innerNodes) {
    ...
    public Node getNode() {
        switch (type) {
            ...
            default:
                 return new Node(node, innerNodes) {

                     @Override
                     public String getCode() {
                         logger.error("Error New Node type: " + getType());
                         return "Error new Node Type" + getType() + "";
                     }
                 };
        }
    }
